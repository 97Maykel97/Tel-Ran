...
const notebook = createProduct('Notebook Lenovo ThinkPad', 'Intel Core i7, RAM: 16 GB', 1283);
const phone = createProduct('Samsung Galaxy', 'AMOLED display, memory: 256 GB', 899);
const headphones = createProduct('Sony Headphones', 'Wireless headphones with noise cancelling', 349);
